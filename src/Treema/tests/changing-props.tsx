...
export const selectStaysOnAddTest: GenericTest = {
  ...
  test: async (ctx) => {
    ...
    await ctx.testingLibrary.fireEvent.click(
      await ctx.testingLibrary.within(ctx.root).findByTestId('test-add-element')
    );
